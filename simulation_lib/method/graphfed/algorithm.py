...
from ..common_import import (AggregationAlgorithm, FedAVGAlgorithm,
                             GraphNodeEmbeddingPassingAlgorithm, Message,
...
class GraphFedAlgorithm(GraphNodeEmbeddingPassingAlgorithm):
    def __init__(self, **kwargs) -> None:
        super().__init__(aggregation_algorithm=PersonalizedFedAVGAlgorithm(), **kwargs)
