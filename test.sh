...
# OBD
python3 ./simulator.py --config-name fed_obd/cifar10.yaml ++fed_obd.round=1 ++fed_obd.epoch=1 ++fed_obd.worker_number=10 ++fed_obd.algorithm_kwargs.random_client_number=10 ++fed_obd.algorithm_kwargs.second_phase_epoch=1 ++fed_obd.debug=False
